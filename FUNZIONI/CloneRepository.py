...
pathDir_File_Link: str = os.environ.get("PROGRAMDATA") + "/clone_push_BitBucket/repository_link_BB.csv"
...
def ScetlaRepository_Clone(SceltaUtente): # restituisce il link della repository scelta / clona da terminale
    ...
    if SceltaUtente.isdigit():
        ...
        if corrispondenza_split[0] != 'git':
            ...
            output = subprocess.check_output(corrispondenza.values[0], shell=True)
